...
sudo pacman -S xorg-server xorg-xinit wget pulseaudio xbindkeys chromium alsa-utils feh zsh pass msmtp isync gimp texlive-core picom neomutt mpv sxiv zathura newsboat calcurse # >/dev/null 2>&1
